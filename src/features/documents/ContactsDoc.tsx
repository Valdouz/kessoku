...
import { useArtists, useFestival, useMembers } from '@/lib/store'
import { ARTIST_KINDS, ARTIST_STATUS, MEMBER_ROLES } from '@/lib/labels'
            ...
            <tbody>
              {members.map((m) => (
                <tr key={m.id}>
                  ...
                  <td className={td}>{MEMBER_ROLES[m.role].label}</td>
